 ...
 //public members
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        _this.emit('share', {
            ...
            // Some other pool software  may need to manually deduct the block subsidy
            // It is not necessary for unomp pools however.
            // This commented out code is left here for the benefit of anyone who might want to copy these changes to other pool software.
            // blockReward: job.rpcData.coinbasevalue - job.rpcData.pow2_subsidy,
