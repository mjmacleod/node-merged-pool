...
var Generation = exports.Generation = function Generation(rpcData, publicKey, extraNoncePlaceholder){
    ...
    var tx = new Transaction({
        ...
        //Some pool software may need to manually subtract the pow2_subsidy - this one does not.
        //value          : rpcData.coinbasevalue - rpcData.pow2_subsidy,
...
var generateOutputTransactions = function(poolRecipient, recipients, rpcData){
    //Some pools may need to manually subtract the pow2_subsidy - this one does not
    //var reward = rpcData.coinbasevalue - rpcData.pow2_subsidy;
